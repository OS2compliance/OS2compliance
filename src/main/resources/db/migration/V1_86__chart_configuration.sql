...
(
    ...
    selectable_date_field      BOOLEAN      NOT NULL DEFAULT FALSE,
    allowed_date_field_choices VARCHAR(255) NULL,
    group_time_by_field        VARCHAR(255) NULL,
    default_start_time         VARCHAR(255) NULL,
    default_end_time           VARCHAR(255) NULL,
