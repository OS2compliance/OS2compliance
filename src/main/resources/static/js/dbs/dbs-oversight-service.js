            ...
            sort: {
                ...
                server: {
                    url: (prev, columns) => {
                        ...
                        const columnIds = ['id', 'supplierId', 'outstandingId', 'name', 'supplier', 'supervisoryModel', 'dbsAssets', 'oversightResponsible', 'lastInspection', 'lastInspectionStatus', 'outstandingTask' ];
